...
export const BOLI_OPEN_WORLD_MISSION: BoliMission = {
  ...
  steps: [
    ...
    { objective: "Say that you can see something in this world.", npcPromptMr: "तुम्हाला इथे काय दिसते?", npcPromptEn: "What can you see here?", targetPhraseMr: "मला इथे काहीतरी दिसते.", targetPhraseLatin: "Mala ithe kahitari disate.", targetPhraseEn: "I can see something here.", successCriteria: "The learner says they can see something, using a clear Marathi sight word such as disate/diste or दिसते.", skill: "clarification" },
